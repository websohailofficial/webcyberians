...
class acfe_field_groups_field extends acf_field{
    ...
    function initialize(){
        ...
        $this->name = 'acfe_field_groups';
        $this->label = __('Field Groups', 'acfe');
        $this->category = 'ACF';
        $this->defaults = array(
            'field_groups'          => array(),
            'field_type'            => 'checkbox',
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            'label'         => __('Allow Field Groups','acf'),
            'instructions'  => '',
            'type'          => 'select',
            'name'          => 'field_groups',
            'choices'       => $this->get_pretty_field_groups(),
            'multiple'      => 1,
            'ui'            => 1,
            'allow_null'    => 1,
            'placeholder'   => __("All field groups",'acf'),
        ));
        ...
        acf_render_field_setting($field, array(
            ...
            'name'          => 'return_format',
            'choices'       => array(
                'object'        => __('Field group object', 'acfe'),
                'name'          => __('Field group key', 'acfe'),
                'id'            => __('Field group ID', 'acfe'),
            ),
            'layout'        => 'horizontal',
        ));
    ...
    function prepare_field($field){
        ...
        // choices
        $field['choices'] = $this->get_pretty_field_groups($field['field_groups']);
...
// initialize
acf_register_field_type('acfe_field_groups_field');
