...
class acfe_fields_field extends acf_field{
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            'label'         => __('Allow Fields','acf'),
            'instructions'  => '',
            'type'          => 'select',
            'name'          => 'fields',
            'choices'       => $this->get_pretty_fields(),
            'multiple'      => 1,
            'ui'            => 1,
            'allow_null'    => 1,
            'placeholder'   => __("All fields",'acf'),
        ));
        ...
        acf_render_field_setting($field, array(
            ...
            'name'          => 'return_format',
            'choices'       => array(
                'object'        => __('Field object', 'acfe'),
                'key'           => __('Field key', 'acfe'),
                'name'          => __('Field name', 'acfe'),
                'id'            => __('Field ID', 'acfe'),
            ),
            'layout'        => 'horizontal',
        ));
...
// initialize
acf_register_field_type('acfe_fields_field');
