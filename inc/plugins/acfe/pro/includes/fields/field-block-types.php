...
if(!class_exists('acfe_block_types')):
...
class acfe_block_types extends acf_field{
    ...
    function initialize(){
        ...
        $this->name = 'acfe_block_types';
        $this->label = __('Block Types', 'acfe');
        $this->category = 'ACF';
        $this->defaults = array(
            'block_types'           => array(),
            'field_type'            => 'checkbox',
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            'label'         => __('Allow Block Types','acf'),
            'instructions'  => '',
            'type'          => 'select',
            'name'          => 'block_types',
            'choices'       => $this->get_pretty_block_types(),
            'multiple'      => 1,
            'ui'            => 1,
            'allow_null'    => 1,
            'placeholder'   => __("All block types",'acf'),
        ));
        ...
        acf_render_field_setting($field, array(
            ...
            'layout'        => 'horizontal',
            'choices'       => array(
                'object'        => __('Block type object', 'acfe'),
                'name'          => __('Block type name', 'acfe'),
            ),
        ));
    ...
    function prepare_field($field){
        ...
        // choices
        $field['choices'] = $this->get_pretty_block_types($field['block_types']);
    ...
    function format_value($value, $post_id, $field){
        ...
        foreach($value as &$v){
            ...
            // get object
            $object = acf_get_block_type("acf/{$v}");
...
// initialize
acf_register_field_type('acfe_block_types');
