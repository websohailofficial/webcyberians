...
if(!class_exists('acfe_location_post_date')):
...
class acfe_location_post_date extends acfe_location{
    ...
    function rule_values($choices, $rule){
        ...
        if(!acf_is_screen('acf-field-group') && !acf_is_ajax('acf/field_group/render_location_rule')){
            ...
            $value = acf_format_date($rule['value'], 'd/m/Y');
    ...
    function rule_match($result, $rule, $screen){
        ...
        $post_date = acf_format_date($post_date, 'Y-m-d');
        $rule['value'] = acf_format_date($rule['value'], 'Y-m-d');
...
acf_register_location_rule('acfe_location_post_date');
